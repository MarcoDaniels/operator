...
describe('user query', () => {
  ...
  it('should match GraphQL object for GetUserQuery', () => {
    ...
    data.resolve({}, { userName: 'this-user' }, {}, {} as GraphQLResolveInfo).then((user: IUser) => {
  ...
  it('should match GraphQL object for ListUserQuery', () => {
    ...
    data.resolve({}, {}, {}, {} as GraphQLResolveInfo).then((users: [IUser]) => {
  ...
  it('should match GraphQL object for ProjectCollaboratorsQuery', () => {
    ...
    data.resolve(projectMock, {}, {}, {} as GraphQLResolveInfo).then((user: [IUser]) => {
      expect(user).toEqual([userMock])
    })
  })
})
